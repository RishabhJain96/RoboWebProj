...
if (isset($_POST['submit'])) {
	...
	$db_name = "RoboticsSIS"; // hardcoded because the user shouldn't have to worry about the database name
	...
	// insert code to create database here
