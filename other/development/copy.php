...
$blacklist = array(".", "..", ".DS_Store", "controllers/apiTester.php", "back_end/dbParameters.txt", "copy.php", "finals_site_code", "previous_versions", "controllers/financeTester.php", "back_end/registerTester.php", "back_end/relationalDBTester.php", "views/resetpass.php", "PHPTM", "back_end/dbUtils.php");
