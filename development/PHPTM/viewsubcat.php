...
echo("<a href=\"taskmgr.php?tl=".$_GET['tl']."&ca=".$_GET['ca']."&su=".$_GET['su']."\">".rawurldecode($_GET['su'])."</a>");
...
$result = mysql_query("SELECT * FROM $tasktablename WHERE tasklist = '".rawurldecode($_GET['tl'])."' AND category = '".rawurldecode($_GET['ca'])."' AND subcategory = '".rawurldecode($_GET['su'])."'", $link);
