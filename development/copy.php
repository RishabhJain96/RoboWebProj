...
$blacklist = array(".", "..", ".DS_Store", "apiTester.php", "dbParameters.txt", "copy.php", "finals_site_code", "fpdf", "previous_versions", "financeTester.php", "registerTester.php", "relationalDBTester.php", "tasksController.php", "resetpass.php");
